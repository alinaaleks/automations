...
SERVICE_MAPPING = {
    ...
    "Стоки ХВ (4.32)": "Стоки ХВ",
    "Стоки ГВ (3.15)": "Стоки ГВ",
    ...
    "ГВ снаб СОИД": "ГВС СОИД",
    "Отопление": "Отопление",
    "Эл.снабж. СОИД": "Электроэнергия СОИД",
    "ХВ снабж. СОИД": "ХВС СОИД",
    "Отв.ст.вод СОИД": "Водоотведение СОИД"
}
